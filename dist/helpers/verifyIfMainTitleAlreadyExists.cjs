...
var verifyIfMainTitleAlreadyExists_exports = {};
__export(verifyIfMainTitleAlreadyExists_exports, {
  verifyIfMainTitleAlreadyExists: () => verifyIfMainTitleAlreadyExists
});
module.exports = __toCommonJS(verifyIfMainTitleAlreadyExists_exports);
...
0 && (module.exports = {
  verifyIfMainTitleAlreadyExists
});
