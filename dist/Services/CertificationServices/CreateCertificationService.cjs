...
var CreateCertificationService_exports = {};
__export(CreateCertificationService_exports, {
  CreateCertificationService: () => CreateCertificationService
});
module.exports = __toCommonJS(CreateCertificationService_exports);
