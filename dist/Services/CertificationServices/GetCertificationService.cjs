...
var GetCertificationService_exports = {};
__export(GetCertificationService_exports, {
  GetCertificationService: () => GetCertificationService
});
module.exports = __toCommonJS(GetCertificationService_exports);
