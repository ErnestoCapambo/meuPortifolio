...
var DeleteHabilityService_exports = {};
__export(DeleteHabilityService_exports, {
  DeleteHabilityService: () => DeleteHabilityService
});
module.exports = __toCommonJS(DeleteHabilityService_exports);
