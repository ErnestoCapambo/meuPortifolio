...
var UpdateMainTitleController_exports = {};
__export(UpdateMainTitleController_exports, {
  UpdateMainTitleController: () => UpdateMainTitleController
});
module.exports = __toCommonJS(UpdateMainTitleController_exports);
