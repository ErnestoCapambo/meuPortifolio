...
var UpdateCertificationController_exports = {};
__export(UpdateCertificationController_exports, {
  UpdateCertificationController: () => UpdateCertificationController
});
module.exports = __toCommonJS(UpdateCertificationController_exports);
  ...
  execute(_0) {
    return __async(this, arguments, function* ({ certification_id, name, link, file_url, file_key }) {
      if (!(yield CertificationRepository().findUnique({ where: { id: certification_id } }))) {
        throw (0, import_http_errors.default)(404, "Certifica\xE7\xE3o n\xE3o encontrada.");
      }
