...
var DeleteMessageController_exports = {};
__export(DeleteMessageController_exports, {
  DeleteMessageController: () => DeleteMessageController
});
module.exports = __toCommonJS(DeleteMessageController_exports);
  ...
  execute(message_id) {
    return __async(this, null, function* () {
      if (!(yield MessageRepository().findUnique({ where: { id: message_id } }))) {
        throw (0, import_http_errors.default)(404, "Mensagem n\xE3o encontrada.");
      }
