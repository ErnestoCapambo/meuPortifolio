...
var UpdateHabilityController_exports = {};
__export(UpdateHabilityController_exports, {
  UpdateHabilityController: () => UpdateHabilityController
});
module.exports = __toCommonJS(UpdateHabilityController_exports);
