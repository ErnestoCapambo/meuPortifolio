...
var DeleteHabilityController_exports = {};
__export(DeleteHabilityController_exports, {
  DeleteHabilityController: () => DeleteHabilityController
});
module.exports = __toCommonJS(DeleteHabilityController_exports);
  ...
  execute(_0) {
    return __async(this, arguments, function* ({ hability_id, user_id }) {
      if (!(yield HabilityRepository().findUnique({ where: { id: hability_id } }))) {
        throw (0, import_http_errors.default)(404, "Habilidade n\xE3o encontrada.");
      }
