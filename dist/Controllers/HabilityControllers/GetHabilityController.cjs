...
var GetHabilityController_exports = {};
__export(GetHabilityController_exports, {
  GetHabilityController: () => GetHabilityController
});
module.exports = __toCommonJS(GetHabilityController_exports);
