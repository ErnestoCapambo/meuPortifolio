...
var UpdateUserImageController_exports = {};
__export(UpdateUserImageController_exports, {
  UpdateUserImageController: () => UpdateUserImageController
});
module.exports = __toCommonJS(UpdateUserImageController_exports);
